...
class Gui:
    ...
    def __init__(self, board: Board, colors_managed_by_gui=(Piece.WHITE, Piece.BLACK), window_title="Chess Game", SCREEN_SIZE=(600, 600), FPS=60, verbose=1):
        self.FPS = FPS
        self.SCREEN_SIZE = SCREEN_SIZE  # Set the default window size to 600x600
    ...
    def generate_textures(self):
        # Moves textures
        Move.TEXTURES = {
            Move.TO_EMPTY_MOVE: pygame.transform.smoothscale(
                image.load(os.path.join(self.ASSETS_FOLDER, "square_of_highlight.png")),
                self.SQUARE_SIZE
            ),
            Move.KILL_MOVE: pygame.transform.smoothscale(
                image.load(os.path.join(self.ASSETS_FOLDER, "square_of_kill.png")),
                self.SQUARE_SIZE
            ),
            Move.SPECIAL_MOVE: pygame.transform.smoothscale(
                image.load(os.path.join(self.ASSETS_FOLDER, "square_of_special.png")),
                self.SQUARE_SIZE
            )
        }

        # Check texture
        Check.IN_CHECK_TEXTURE = pygame.transform.smoothscale(
            image.load(os.path.join(self.ASSETS_FOLDER, "square_of_in_check.png")),
            self.SQUARE_SIZE
        )

        # Cases textures
        Case.BLACK_TEXTURE = pygame.transform.smoothscale(
            image.load(os.path.join(self.ASSETS_FOLDER, "black_square.png")),
            self.SQUARE_SIZE
        )
        Case.WHITE_TEXTURE = pygame.transform.smoothscale(
            image.load(os.path.join(self.ASSETS_FOLDER, "white_square.png")),
            self.SQUARE_SIZE
        )
